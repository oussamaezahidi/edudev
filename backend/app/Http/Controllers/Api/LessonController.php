...
class LessonController extends Controller
{
    ...
    {
        $query = Lesson::query()->with(['course:id,title', 'trainer:id,name']);
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        return response()->json($lesson->load(['course:id,title', 'trainer:id,name']), 201);
    }
    ...
    public function show(Request $request, Lesson $lesson): JsonResponse
    {
        ...
        return response()->json($lesson->load(['course:id,title', 'trainer:id,name']));
    }
